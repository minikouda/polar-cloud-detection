...
\title{Arctic Cloud Detection using Multi-Angle Satellite Imagery\vspace{-2em}}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/eda/cloud_map_labeled.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/eda/outlier_spatial_combined.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.55\textwidth]{figures/eda/radiance_correlation_heatmap.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/eda/feature_distributions_by_class.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/eda/ndai_vs_corr_kde.pdf}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.65\textwidth]{figures/autoencoder/Autoencoder Training Total Loss.png}
